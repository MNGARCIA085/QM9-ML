...
```bash
python -m scripts.training model_type=gcn model_type.training.hidden=256
python -m scripts.training model_type=gcn model_type.training.hidden=256 shared.epochs=7
python -m scripts.tuning model_type=schnet
python -m scripts.tuning model_type=mlp preprocessor.val_ratio=0.1 shared.num_trials=10
